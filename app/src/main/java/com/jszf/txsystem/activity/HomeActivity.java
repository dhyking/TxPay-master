...
import com.jszf.txsystem.fragment.BillFragment;
...
public class HomeActivity extends MvpActivity<IHomeView, HomePresenterImpl> implements View.OnClickListener, IHomeView {
    ...
    private int[] unSelectDrawble = new int[]{R.drawable.home_collection_normal,R.drawable.home_account_normal,
            R.drawable.home_message_normal, R.drawable.home_mine_normal};
    private int[] SelectDrawble = new int[]{R.drawable.home_collection_press,R.drawable.home_account_press,
            R.drawable.home_message_press, R.drawable.home_mine_press};
    private String mUuid;
    private SharedPreferences mSp;
    private boolean[] isSelceted = new boolean[4];
    ...
    private static final int TAB_BILL = 1;          //账单
    private static final int TAB_MESSAGE = 2;      //消息
    private static final int TAB_MYSELF = 3;        //我的
...
//    MD5:dea4c02423794a8ead4743b10a79126f
    ...
    private void initRequest() {
        ...
        ivArr[1] = mIvHomeAccount;
        ivArr[2] = mIvHomeMessage;
        ivArr[3] = mIvHomeMyself;
        ...
        switch (position) {
            ...
            case TAB_BILL:
                if (billFragment == null) {
                    ...
                    transaction.add(R.id.ll_home_container, billFragment);
                }else {
